...
class CR4MeditationClockMenu extends CR4MenuBase
{
	...
	{	
		...
		// modcrab - for localising the menu, you can change these strings/numbers to whatever you like
		m_flashValueStorage.SetFlashBool(   "meditation.clock.sleeping", GetWitcherPlayer().ModcrabIsPlayerSleeping() );
		m_flashValueStorage.SetFlashString( "meditation.clock.alchemy.prompt.label", "Alchemy" );
		m_flashValueStorage.SetFlashNumber( "meditation.clock.alchemy.prompt.gamepad.width", 135 );
		m_flashValueStorage.SetFlashString( "meditation.clock.meditate.prompt.label", "Meditate" );
