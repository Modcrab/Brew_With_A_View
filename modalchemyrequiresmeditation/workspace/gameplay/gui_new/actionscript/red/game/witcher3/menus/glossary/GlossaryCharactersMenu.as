...
package red.game.witcher3.menus.glossary
{
	...
	public class GlossaryCharactersMenu extends CoreMenu
	{
		/********************************************************************************************************************
				ART CLIPS
		/ ******************************************************************************************************************/
		...
		public function GlossaryCharactersMenu()
		{
			super();
			mcMainListModule.menuName = menuName;
			mcTextAreaModule.dataBindingKey = "glossary.characters.description";
		}

		override protected function get menuName():String
		{
			return "GlossaryCharactersMenu";
		}
