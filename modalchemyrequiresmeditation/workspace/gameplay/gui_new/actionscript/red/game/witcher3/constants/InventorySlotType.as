package red.game.witcher3.constants
{
	...
	{
		public static const InvalidSlot:int = 0;	// E.g., something that doesn't go in any slot
		...
		public static const Unused1:int = 16; // #B deprecated
