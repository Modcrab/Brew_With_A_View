...
package scaleform.clik.controls 
{
    ...
    // Public Methods:
        ...
        public function set selectedIndex(value:int):void {
            ...
            if (_dropdownRef != null && _dropdownRef is CoreList) { // #W3 we use dropdown menu with types that are not derived from CoreList
         ...
         */
        public function open(allowSound : Boolean = true):void {
            selected = true;
