...
package scaleform.clik.controls 
{
    ...
    // Public Getter / Setters:
        ...
        public function set selectedIndex(value:int):void {
            ...
            dispatchEvent(new ListEvent(ListEvent.INDEX_CHANGE, true, false, _selectedIndex, -1, -1, getRendererAt(_selectedIndex), dataProvider.requestItemAt(_selectedIndex)));
        }
    ...
    // Protected Methods:
        ...
        protected function dispatchItemEvent(event:Event):Boolean {
            ...
            var newEvent:ListEvent = new ListEvent(type, false, true, renderer.index, 0, renderer.index, renderer, dataProvider.requestItemAt(renderer.index), controllerIdx, buttonIdx, isKeyboard);
